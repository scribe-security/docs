          ...
          include: [
            ...((isPullRequest && branch.includes("dev-preview") || 
              ...
              '**/*.md',
                ...
                "use-cases/software-producer/source-code-integrity.md",
                "use-cases/software-producer/sign-verify.md",
                "use-cases/software-producer/tracking-vulnerabilities.md",
                "use-cases/software-producer/complying-security-standards.md",
                ...
                "how-to-run-scribe/CLI/valint/README.md",
                "how-to-run-scribe/CLI/valint/docs/command/valint.md",
                "how-to-run-scribe/CLI/valint/docs/command/valint_bom.md",
                "how-to-run-scribe/CLI/valint/docs/command/valint_verify.md",
                "how-to-run-scribe/CLI/valint/docs/attestations.md",
                "how-to-run-scribe/CLI/valint/docs/configuration.md",
                "how-to-run-scribe/CLI/valint/report.md",
                "how-to-run-scribe/CLI/gensbom/gensbomcli.md",
                "how-to-run-scribe/CLI/valint/command/valint.md",
                "how-to-run-scribe/CLI/valint/command/valint_report.md",
  ...
  themeConfig:
    ...
    navbar: {
      ...
      items: [
        ...
        {to: 'docs/how-to-run-scribe/ci-integrations/', label: 'How to run Scribe', position: 'left'},   
