<p><a target="_blank" href="https://app.eraser.io/workspace/guQgJhNwdTJJQy3GWJ1V" id="edit-in-eraser-github-link"><img alt="Edit in Eraser" src="https://firebasestorage.googleapis.com/v0/b/second-petal-295822.appspot.com/o/images%2Fgithub%2FOpen%20in%20Eraser.svg?alt=media&amp;token=968381c8-a7e7-472a-8ed6-4a6626da5501"></a></p>
...
![Version: 0.1.4-1](https://img.shields.io/badge/Version-0.1.4--1-informational?style=flat-square "")
...
2. If [oci-repo] is a private registry, attach permissions to the admission with the following steps:kubectl create secret docker-registry [secret-name] --docker-server=[registry_url] --docker-username=[username] --docker-password=[access_token] -n scribe
    1. Create a secret:
3. Install admission with an OCI registry as the evidence store:helm install admission-controller scribe/admission-controller -n scribe \
...
Namespaces will trigger Scribe admission logic on all its resources *_matching_ any regular expression specified by the `glob` fields.
...
| config.attest.cocosign.storer.OCI.enable | bool |  | OCI evidence enable |
| config.attest.cocosign.storer.OCI.repo | string |  | OCI evidence repo location |
| config.attest.default | string |  | Signature verification type |
| config.context.name | string |  | Scribe Project Key |
| config.verify.input-format | string |  | Evidence format |
| imagePullSecrets | list |  | OCI evidence store secret name |
| scribe.auth.client_secret | string |  | Scribe Client Secret |
| scribe.service.enable | bool |  | Scribe Client Enable |
| serviceMonitor.enabled | bool |  |  |
| webhook.env | object |  |  |
| webhook.extraArgs.structured | bool |  |  |
| webhook.extraArgs.verbose | int |  |  |
| webhook.image.pullPolicy | string |  |  |
| webhook.image.repository | string |  |  |
| webhook.image.version | string |  |  |
| webhook.name | string |  |  |
| webhook.podSecurityContext.allowPrivilegeEscalation | bool |  |  |
| webhook.podSecurityContext.capabilities.drop[0] | string |  |  |
| webhook.podSecurityContext.enabled | bool |  |  |
| webhook.podSecurityContext.readOnlyRootFilesystem | bool |  |  |
| webhook.podSecurityContext.runAsUser | int |  |  |
| webhook.replicaCount | int |  |  |
| webhook.secretName | string |  |  |
| webhook.securityContext.enabled | bool |  |  |
| webhook.securityContext.runAsUser | int |  |  |
| webhook.service.annotations | object |  |  |
| webhook.service.port | int |  |  |
| webhook.service.type | string |  |  |
| webhook.serviceAccount.annotations | object |  |  |
| webhook.webhookName | string |  |  |




<!--- Eraser file: https://app.eraser.io/workspace/guQgJhNwdTJJQy3GWJ1V --->