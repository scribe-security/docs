<p><a target="_blank" href="https://app.eraser.io/workspace/VM6IDCOvOLN2dFtok0Vr" id="edit-in-eraser-github-link"><img alt="Edit in Eraser" src="https://firebasestorage.googleapis.com/v0/b/second-petal-295822.appspot.com/o/images%2Fgithub%2FOpen%20in%20Eraser.svg?alt=media&amp;token=968381c8-a7e7-472a-8ed6-4a6626da5501"></a></p>
...
#### Before you begin
Integrating Scribe Hub with admission controller requires the following credentials that are found in the **Integrations** page. (In your [﻿Scribe Hub](https://prod.hub.scribesecurity.com/) go to **integrations**)
...
![Policy Results view](../../../../img/cicd/admission_demo_results.png "")

 Policy Result Context 

![Context Details view](../../../../img/cicd/admission_result_context.png "")
...
By default, the provider is installed with a policy to warn on _ANY_ image that is not signed. This serves as a basic security measure to alert users about potentially risky, unsigned images.
...
Valint supports both storage and verification flows for `attestations` and `statement` objects using an *_OCI_ registry as an evidence store. 
...
- Write access to upload policy report evidence for the provider. Can be skipped when `valint.attest.report.disable`  is set to true 
...
<!--- Eraser file: https://app.eraser.io/workspace/VM6IDCOvOLN2dFtok0Vr --->