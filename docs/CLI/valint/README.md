...
At the end of your pipeline run, use Valint to decide to accept or fail a build, depending on the integrity analysis result reported by Scribe.  
...
* **Product Key** (The product key generated by Scribe Hub is optional, you can use your own Product Key) 
* **Client ID**
* **Client Secret**
...
### Requesting specific detail types
