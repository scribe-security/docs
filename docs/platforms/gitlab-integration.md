<p><a target="_blank" href="https://app.eraser.io/workspace/1UqsQ3aqlGhj8SPJKpyM" id="edit-in-eraser-github-link"><img alt="Edit in Eraser" src="https://firebasestorage.googleapis.com/v0/b/second-petal-295822.appspot.com/o/images%2Fgithub%2FOpen%20in%20Eraser.svg?alt=media&amp;token=968381c8-a7e7-472a-8ed6-4a6626da5501"></a></p>
...
- remote: `https://raw.githubusercontent.com/scribe-public/gitlab_platforms/main/[ Job ]
  inputs:
    [ARGS]
```
1. **Set Global Variables**: Customize global variables according to your environment and requirements.
2. **Configure Stages**: Customize stages based on your platform (GitLab, Dockerhub, or Kubernetes).
3. **Adjust Runner Considerations**: Ensure your CI/CD runner environment meets the necessary requirements for cache management and optimal performance.
...
| ----- | ----- | ----- |
|  | Discovers artifacts in GitLab environment. |  |
|  | Discovers artifacts in Dockerhub environment. | <p></p><p></p> |
|  | Discovers artifacts in Kubernetes environment. | <p></p><p></p> |
...
| Job | Description |
| ----- | ----- |
|  | Creates and signs SBOMs for Dockerhub. |
|  | Creates and signs SBOMs for Kubernetes. |
## `policy` Stage
...
| Job | Description |
| ----- | ----- |
|  | Evaluates policy against GitLab evidence. |
|  | Evaluates policy against Dockerhub evidence. |
|  | Evaluates policy against Kubernetes evidence. |
...
| Variable | Description |
| ----- | ----- |
|  | Version of the Platforms tool. |
|  | Scribe Service Client Secret. |
|  | Enable Scribe Service. |
|  | Context type to use. |
|  | Disable evidence cache. |
|  | Evidence signing key. |
|  | Evidence signing certificate (use PEM format). |
|  | Evidence signing CA (use PEM format). |
|  | GitLab discovery token. |
|  | Kubernetes discovery token. |
|  | Kubernetes discovery URL. |
|  | Dockerhub username. |
|  | Dockerhub password. |
|  | Docker driver to use. |
|  | Docker TLS verify. |
|  | Docker TLS cert directory. |
|  | Docker cert path. |
|  | Docker host. |
|  | Path to monitor for space usage. |
|  | If true, clean up docker cache if space is low. |
|  | Threshold for space usage. |
|  | Log level to use. |
|  | Enable API trace mode. |
|  | Valint log level to use. |
## Hosted Runner Setup
...
<!--- Eraser file: https://app.eraser.io/workspace/1UqsQ3aqlGhj8SPJKpyM --->