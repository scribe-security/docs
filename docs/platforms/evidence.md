...
options:
  ...
  --max-threads MAX_THREADS
                        ...
                        evidence collection (type: int, default: 10)
  --thread-timeout THREAD_TIMEOUT
  ...
  --valint.label LABEL  Set additional labels (type: <function
                        <lambda> at 0x7fd3675d0fe0>, default: [])
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] evidence [options] github
       [-h] [--instance INSTANCE] [--token TOKEN] [--url URL]
       ...
       [--default_product_key_strategy {mapping}]
       [--organization.mapping [MAPPING ...]]
       [--repository.mapping [MAPPING ...]] [--organization.single]
       [--repository.single]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] evidence [options] ecr [-h]
                                                  [--instance INSTANCE]
                                                  [--url URL]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] evidence [options] bitbucket
       [-h] [--instance INSTANCE]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] evidence [options] jenkins
       [-h] [--instance INSTANCE]
...
options:
  ...
  --folder.mapping [MAPPING ...]
                        ...
                        wildcards are supported (type:
                        AssetMappingString, default: [])
  --folder.single       Export all repos in a single evidence
                        (default: False)
```
<!-- { "object-type": "command-output-end" } -->
