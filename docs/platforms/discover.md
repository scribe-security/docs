...
options:
  ...
  --scope.workflow.run [RUN ...]
                        Scope Workflow runs by ID (default: ['*'])
  ...
  --hook [HOOK ...]     Specify hook IDs to execute. Available preconfigured hooks are: trivy_iac_and_secrets, trivy_iac_and_secrets_sarif. (default: [])
