...
options:
  ...
  --valint.label LABEL  Set additional labels (type: <function <lambda> at 0x7a0986a72480>, default: [])
...
options:
  ...
  --hook [HOOK ...]     Specify hook IDs to execute. Available preconfigured hooks are: trivy_iac_and_secrets, ggshield_secret. (default: [])
