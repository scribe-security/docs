...
```bash
usage: platforms [options] bom [-h] [--allow-failures] [--save-scan-plan] [--dry-run]
                               [--monitor.mount MOUNT] [--monitor.threshold THRESHOLD]
                               [--monitor.clean-docker] [--max-threads MAX_THREADS]
                               ...
                               [--valint.components COMPONENTS] [--valint.label LABEL]
                               [--unique]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] dockerhub [-h] [--instance.instance INSTANCE]
                                                   [--username USERNAME]
...
options:
  ...
  --default_product_key_strategy {namespace,repository,tag,mapping}
                        ...
                        (default: mapping)
  --default_product_version_strategy {tag,short_image_id,image_id}
                        Override product version with tag or image id (default:
                        short_image_id)
  --scope.repository [REPOSITORY ...]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] k8s [-h] [--instance.instance INSTANCE]
                                             [--url URL] [--token TOKEN]
...
options:
  ...
  --default_product_key_strategy {namespace,pod,image,mapping}
                        ...
                        mapping)
  --default_product_version_strategy {namespace_hash,pod_hash,image_id}
                        Override product version with namespace, pod or image names
                        (default: namespace_hash)
  --scope.namespace [NAMESPACE ...]
  ...
  --image.mapping [MAPPING ...]
                        ...
                        image::product_key::product_version (type: K8sImageMappingString,
                        default: [])
```
<!-- { "object-type": "command-output-end" } -->
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] jfrog [-h] [--instance.instance INSTANCE]
                                               [--token TOKEN] [--url URL]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] ecr [-h] [--instance.instance INSTANCE]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] bitbucket [-h] [--instance.instance INSTANCE]
...
options:
  ...
  --types {repository,all}
                        Specifies the type of evidence to generate, scoped by scope
                        parameters (default: repository)
  --scope.workspace [WORKSPACE ...]
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] github [-h] [--instance.instance INSTANCE]
                                                [--token TOKEN] [--url URL]
                                                [--types {repository,all}]
...
options:
  ...
  --hook-config [HOOK_CONFIG ...]
                        ...
                        str, default: [])
  --hook [HOOK ...]     Specify hook IDs to execute. Available preconfigured hooks are:
                        trivy_iac_and_secrets, ggshield_secrets, hadolint,
...
<!-- { "object-type": "command-output-start" } -->
```bash
usage: platforms [options] bom [options] gitlab [-h] [--instance.instance INSTANCE]
                                                [--token TOKEN] [--url URL]
                                                [--types {project,all}]
                                                [--scope.organization [ORGANIZATION ...]]
                                                [--scope.project [PROJECT ...]]
                                                [--scope.branch [BRANCH ...]]
                                                [--scope.tag [TAG ...]] [--commit.skip]
                                                [--pipeline.skip]
                                                [--default_product_key_strategy {mapping}]
                                                [--organization.mapping [MAPPING ...]]
                                                [--project.mapping [MAPPING ...]]
