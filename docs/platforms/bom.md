...
usage: platforms [options] bom [-h] [--allow-failures] [--save-scan-plan] [--dry-run] [--monitor.mount MOUNT]
                               ...
                               [--valint.scribe.client-id CLIENT_ID] [--valint.scribe.client-secret CLIENT_SECRET] [--valint.scribe.enable]
                               ...
                               [--valint.disable-evidence-cache] [--valint.sign] [--valint.components COMPONENTS] [--unique]
