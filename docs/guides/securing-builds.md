...
1. Utilize *Valint* to cryptographically sign your repository after each commit. Then, verify that the signed version and the source code files pulled into your CI/CD at checkout match. 
<!-- For a more in-depth explanation of Valint's sign-verify capabilities go **[here](secure-sfw-slsa/#signing--verifying-attestations "Signing And Verifying Attestations")**.  -->
