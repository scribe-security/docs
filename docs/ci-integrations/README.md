...
Scribe allows you to integrate our *SBOM* creation tool directly into your pipeline so that they may be viewed and shared directly from Scribe Hub. Below are two suggested integrations, using <a href='/docs/ci-integration/github-actions'>GitHub actions</a> and <a href='/docs/ci-integration/jenkins'>Jenkins over Kubernetes</a>. We also offer a more generalized option allowing integration with other <a href='/docs/ci-integration/general'>CI systems</a>.  
...
:::info GitHub actions
<img src='../../img/ci/github.png' alt='GitHub' width="30px"/> Integrate as a step in <b><a href='/docs/ci-integration/github-actions'>GitHub actions</a></b>. 
:::

:::info Jenkins
<img src='../../img/ci/jenkins.png' alt='Jenkins' width="30px"/> Integrate as a step in a <b><a href='/docs/ci-integration/jenkins'>Jenkins</a></b> pipeline.  
Important to note that this is for <b>Jenkins over Kubernetes</b> only. 
:::

:::info Other CI Systems
Integrate into other <b><a href='/docs/ci-integration/general'>CI systems</a></b>.  
:::
