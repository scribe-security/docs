<p><a target="_blank" href="https://app.eraser.io/workspace/QbZ8HzQBzNt0QSzhV28Q" id="edit-in-eraser-github-link"><img alt="Edit in Eraser" src="https://firebasestorage.googleapis.com/v0/b/second-petal-295822.appspot.com/o/images%2Fgithub%2FOpen%20in%20Eraser.svg?alt=media&amp;token=968381c8-a7e7-472a-8ed6-4a6626da5501"></a></p>
...
cocosign:
  ...
  storer:
    rekor:
      ...
      disablebundle: false
```
 Sigstore public instance - Github workfload identity 

 Sigstore signer and verifier allow you to use ephemeral short living keys based on OIDC identity (google, microsoft, github). Sigstore will also provide a transperancy log for any one to verify your signatures against (`rekor`) 
...
<!--- Eraser file: https://app.eraser.io/workspace/QbZ8HzQBzNt0QSzhV28Q --->